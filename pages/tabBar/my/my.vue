			...
			<view class="section__bd">
				<view class="dd-list col__list li_20 center clear pt5 flex" >
					<view class="item flex1" @click="golink('/pages/member/order/order?tabIndex=1')">
						<view class="iconImg">
							<image class="icon" src="http://ddyp.wtvxin.com/static/icons/u_order1.png" mode="widthFix"></image>
					...
					<view class="item flex1" @click="golink('/pages/member/order/order?tabIndex=6')">
						<view class="iconImg">
							<image class="icon" src="http://ddyp.wtvxin.com/static/icons/u_order6.png" mode="widthFix"></image>
					...
					<view class="item flex1" @click="golink('/pages/member/order/order?tabIndex=2')">
						<view class="iconImg">
							<image class="icon" src="http://ddyp.wtvxin.com/static/icons/u_order2.png" mode="widthFix"></image>
					...
					<view class="item flex1" @click="golink('/pages/member/order/order?tabIndex=3')">
						<view class="iconImg">
							<image class="icon" src="http://ddyp.wtvxin.com/static/icons/u_order3.png" mode="widthFix"></image>
			...
			<view class="section__bd Sevice">
				<view class="dd-list col__list li_25 center clear">
					...
					<view class="item" @click="golink('/pages/other/myAcount/myAcount')">
						<image class="iconImg" src="http://ddyp.wtvxin.com/static/icons/u_sy.png" mode=""></image>
					...
					<view class="item" @click="golink('/pages/member/orderTui/orderTui')">
						<image class="iconImg" src="http://ddyp.wtvxin.com/static/icons/u_order7.png" mode=""></image>
					...
					<view class="item" @click="golink('/pages/member/invoiceList/invoiceList')">
						<image class="iconImg" src="http://ddyp.wtvxin.com/static/icons/u_fp.png" mode=""></image>
						<view class="txt">发票信息</view>
					</view>
					<view class="item" @click="golink('/pages/member/invite/invite')">
						<image class="iconImg" src="http://ddyp.wtvxin.com/static/icons/u_yq.png" mode=""></image>

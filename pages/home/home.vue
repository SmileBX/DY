	...
	<view class="home">
		...
		<view class="index_nav uni-tab-bar">
			<view class="flex justifyContentBetween">
				...
				<view>
					<span class="iconfont icon-iconfontzhizuobiaozhun17 mr2"></span>
					<span class="iconfont icon-leimupinleifenleileibie"></span>
				</view>
			</view>
			<scroll-view id="tab-bar" class="uni-swiper-tab mt2" scroll-x :scroll-left="scrollLeft">
				<view v-for="(tab,index) in datalist" :key="tab.id" :class="['swiper-tab-list',tabIndex==index ? 'active' : '']" :id="'tabNum'+index"
				 :data-current="index">
				...
				<swiper class="swiper" :indicator-dots="true" :autoplay="false" :interval="5000" :duration="500">
					<swiper-item v-for="(banner,index) in 4" :key="index">
						<view class="swiper-item" @click="toBannerlink(banner.Url)">
							<image class="img" src="../../static/home/banner.png" mode="aspectFill"></image>
						</view>
					</swiper-item>
				</swiper>
			</view>
		...
		<scroll-view  class="tab_list" scroll-x :scroll-left="scrollLeft2">
			<view v-for="(tab,index) in 8" :key="tab.id" class="tab_item">
				<view v-for="(item,ell) in 2" :class="[tabIndex==ell ? 'active' : '']" :id="'tabNum'+ell"
				 :data-current="ell" :key="ell">
					 <view>
						<image src="../../static/home/4.png" class="tab_img"></image> 
					 </view>
		...
		<view class="index_pin">
			<view class="pin_title">大 单 易 拼 品 牌 馆 </view>
				...
				<view class="pin_item" v-for="(item,key) in 4" :key="key" :class="{'bg1':key==0,'bg2':key==1,'bg3':key==2,'bg4':key==3}">
					...
					<view class="flex justifyContentBetween item_info">
						...
						<view class="right_img">
							<image src="../../static/home/2.png" mode="aspectFill"></image>
						</view>
					</view>
				</view>
		...
		<!--特惠-->
		<view class="hui mt2">
			<image src="../../static/home/f2.png" class="hui_bg"></image>
		...
		<!--推荐-->
		<view class="jian mt2">
			<image src="../../static/home/f3.png" class="jian_bg"></image>
						...
						<view class="scroll-view-item_H" v-for="(item,index) in 6" :key="index" @click="goDetail(item.Id)">
							<view class="itembox">
								<view class="image-view">
									<image class="img" src="../../static/home/3.png" mode="aspectFill"></image>
								</view>
								<view class="txtbox">
		...
		<view class="menu">
			...
			<view class="list flex flexWrap justifyContentBetween">
				<view class="item" v-for="(item,index) in 6" :key="index">
					<image src="../../static/home/4.png" class="item_img"></image>
	...
	export default{
		data(){
			return{
				...
				datalist:[{id:1,TypeName:'今日推荐'},{id:1,TypeName:'今日推荐'},{id:1,TypeName:'特价倒计时'},{id:1,TypeName:'房产'},{id:1,TypeName:'家居'},{id:1,TypeName:'大健康'}]
			}
		},
		mthods:{
			scrollLeft(){

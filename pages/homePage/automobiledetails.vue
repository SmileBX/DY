	...
	<view class="details">
		...
		<view class="detailsmap">
			...
			<view class="signboard">
				<view class="back" @click="toindex()">
					<image class="backimg" src="../../static/hpicons/back.svg" mode=""></image>
				</view>
				<view class="back" style="margin-left: 450rpx;">
					<image class="cartimg" src="../../static/hpicons/cart.svg" mode=""></image>
				</view>
				<view class="back" style="margin-left: 40rpx;">
					<image class="shareimg" src="../../static/hpicons/share.svg" mode=""></image>
				</view>
			</view>
		...
		<view class="">
			<view class="listpt">
				<view class="listprice">
					<view class="listm">
						<view class="selling"><span>¥</span>13万</view>
						<view class="original">¥14万</view>
					</view>
					<view class="listm rt">
						<view class="cash">返</view>
						<view class="cashm">¥万</view>
					</view>
				</view>
			</view>
			<view class="discount">
				...
				<view class="payment">68人付款</view>
			</view>
			<view class="site">
				<view class="slogan">奥迪</view>
				<view class="area">
					<view class="">地址：南山后海观海台花园</view>
					<!-- <view class="">面积：14m -25m</view> -->
				</view>
			</view>
			<view class="purchase">
				<view class="picture">
		...
		<view class="serial">
			<view class="need">
				...
				<view class="parking">
					<image class="saarch" src="../../static/hpicons/search.svg"></image>
			...
			<view class="complete">查看全部<image class="double" src="../../static/hpicons/double.svg"></image></view>
		</view>
		<!-- 品牌介绍 -->
		<view class="needknow">
			<view class="pole"></view>
...
<!-- 			<view class="pledge">
		...
		<!-- 医院信息 -->
		<view class="hospital">
			<view class="information">车辆配置</view>
			<!-- <view class="reexamine">杭州芯美昕医疗美容门诊</view> -->
			<view class="">
				<view class="establish">
					<view class="" style="width: 20%;">车身结构</view>
					<view class="quantum">4门5座三厢车（紧凑型车）</view>
				</view>
				<view class="establish">
					<view class="" style="width: 20%;">发动机</view>
					<view class="quantum">2.0T 184马力L4</view>
				</view>
				<view class="establish">
					<view class="" style="width: 20%;">变速箱</view>
					<view class="quantum">8挡手自一体</view>
				</view>
				<view class="establish">
					<view class="" style="width: 20%;">能源类型</view>
					<view class="quantum">汽油</view>
				</view>
				<view class="establish">
					<view class="" style="width: 20%;">综合油耗</view>
					<view class="quantum">6.50L /100km(工信部)</view>
				</view>
			</view>
		</view>
		<view class="pole"></view>
		<!-- 地理位置 -->
		<view class="instaPlace">
			<view class="" style="font-size: 32rpx;">地理位置</view>
			<view class="" style="font-size: 32rpx;">宝安 宝安中心区 天健时尚空间</view>
			<view class="road">距离宝华站地铁站357米</view>
			<view class="print">
				<image style="width: 47rpx; height: 47rpx; background: #007AFF;" src="" mode=""></image>
			</view>
		</view>
		<view class="pole"></view>
		...
		<view class="graphic">
			...
			<image class="Product" src="" mode=""></image>
			<image class="Product" src="" mode=""></image>
			<image class="Product" src="" mode=""></image>
		</view>
		<!-- 购物价格详细 -->
		<view class="base" style="border-top: 1rpx solid rgba(237,237,237,1);">
			<view class="bases">
				<image class="customer" src="../../static/hpicons/customer.svg" mode=""></image>
				<view class="">客服</view>
			</view>
			<view class="bases">
				<image class="store" src="../../static/hpicons/store.svg" mode=""></image>
				<view class="">店铺</view>
			</view>
			<view class="bases">
				<image class="collect" src="../../static/hpicons/collect.svg" mode=""></image>
				<view class="">收藏</view>
			</view>
			<view class="alone">
				<view class="buy">
					<view class="" style="font-size: 28rpx;">¥3万</view>
					<view class="give">单独购买</view>
				</view>
				<view class="buyr">
					<view class="" style="font-size: 28rpx; margin-left: 10rpx;">¥2.9万</view>
					<view class="" style="font-size: 24rpx; margin-top: -14rpx;margin-left: 10rpx;">我要拼团</view>
					<view class="listm rt buys">
						<view class="cash fa" >返</view>
						<view class="cashm fas">¥2万</view>
					</view>
				</view>
			</view>
...
<style scoped>
	...
	.detailsmap{
		width:100%;
		height:700rpx;
		/* background:rgba(67,66,64,1); */
		background: #C0C0C0;
	}
	.signboard{
		display: flex;
		/* justify-content: space-between; */
		padding: 0rpx 24rpx 31rpx 30rpx;
		position: absolute;
		top: 60rpx;
	}
	.back{
	...
	.merging:before {
	    ...
	    height: 10rpx;
	    width: 10rpx;
	    border-top: 1rpx solid #f63517;
	    border-right: 1rpx solid #f63517;
	    top: 50%;
		left: -7rpx;
	    margin-top: -4rpx;
	    background: #fff;
	...
	.flow{
		margin:75rpx 30rpx 30rpx 30rpx;
		width:690rpx;
		height:755rpx;
		border:2rpx solid rgba(254,143,45,0.3);
		border-radius:30rpx;
	}	
	.process{
		width:320rpx;
		height:65rpx;
		background:linear-gradient(-89deg,rgba(254,142,44,1) 0%,rgba(254,198,76,1) 100%);
		box-shadow:0px 5px 6px 0px rgba(249,61,36,0.42);
		border-radius:33rpx;
		text-align: center;
		font-size:30rpx;
		font-family:PingFang;
	...
	.serialimg{
		width:94rpx;
		height:94rpx;
		border:2rpx solid rgba(251,134,84,1);
		border-radius:50%;
	}
	.once{
		font-size:36rpx;

		...
		<view class="">
			<view class="listpt">
				<view class="listprice">
					<view class="listm">
						<view class="selling"><span>¥</span>1380</view>
						<view class="original">¥1480</view>
					</view>
					<view class="listm rt">
						<view class="cash">返</view>
						<view class="cashm">¥200</view>
					</view>
				</view>
			</view>
			<view class="discount">
			...
			<view class="site">
				<view class="slogan">北欧现代简约玻璃门衣柜</view>
				<view class="area">
					<view class="" style="padding-right: 70rpx;">E1级环保烤漆高密度板 五金承重脚 优质五金配件</view>
